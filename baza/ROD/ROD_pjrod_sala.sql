...
--
-- Table structure for table `pjrod_sala`
--

DROP TABLE IF EXISTS `pjrod_sala`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pjrod_sala` (
...
--
-- Dumping data for table `pjrod_sala`
--

LOCK TABLES `pjrod_sala` WRITE;
/*!40000 ALTER TABLE `pjrod_sala` DISABLE KEYS */;
/*!40000 ALTER TABLE `pjrod_sala` ENABLE KEYS */;
UNLOCK TABLES;

...
--
-- Table structure for table `pjrod_faktura`
--

DROP TABLE IF EXISTS `pjrod_faktura`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pjrod_faktura` (
...
--
-- Dumping data for table `pjrod_faktura`
--

LOCK TABLES `pjrod_faktura` WRITE;
/*!40000 ALTER TABLE `pjrod_faktura` DISABLE KEYS */;
/*!40000 ALTER TABLE `pjrod_faktura` ENABLE KEYS */;
UNLOCK TABLES;
